...
cat << EOF
Warning: This script will destroy your existing .bashrc, .bash_profile, .bash_logout, .screenrc, and .vimrc!  Do you want to continue?  (type yes to continue.)
EOF
...
set -x
rm -f ~/.{bashrc,bash_profile,bash_logout,screenrc,vimrc}
...
ln -sf ${dotfile_dir}/screenrc ~/.screenrc
